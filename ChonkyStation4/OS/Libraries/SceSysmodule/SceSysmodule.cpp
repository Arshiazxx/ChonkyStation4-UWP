...
void init(Module& module) {
    ...
    module.addSymbolStub("g8cM39EUZ6o", "sceSysmoduleLoadModule", "libSceSysmodule", "libSceSysmodule", 0x100000);
    ...
    module.addSymbolStub("D8cuU4d72xM", "sceSysmoduleGetModuleHandleInternal", "libSceSysmodule", "libSceSysmodule", 0x100000);
}
